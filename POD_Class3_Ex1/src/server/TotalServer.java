...
public class TotalServer implements Remote{
	public static void main(String[] args)
	{
		try
		{
			...
			TotalServer server = new TotalServer();

			registry.rebind("Estadistica", server);
	...
	public TotalServer() throws RemoteException
	{
	...
	{
		String s = String.format("%s (%d)",Thread.currentThread().getName(),Thread.currentThread().getId());
